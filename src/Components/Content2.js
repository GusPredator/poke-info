  ...
  handledInputChanged(e){
    if(e.target.id === "firstPoke"){
      this.setState({
        ...
        option1A: this.state.option1 + 1
      })
    }
      if(e.target.id === "secondPoke"){
        this.setState({
          option2: Number(e.target.value),
          option2B: this.state.option2 + 1
        })
      }
        if(e.target.id === "thirdPoke"){
          this.setState({
            option3: Number(e.target.value),
            option3C: this.state.option3 + 1
          })
        }
  }
        ...
        <div className="Content">
          ...
          <div className="pokeContent">
            <div className="subPokeContent1">
              ...
              <p> {this.state.option1A} </p>
              <p> {this.state.option2B} </p>
              <p> {this.state.option3C} </p>
